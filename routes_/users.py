...
from modules.users import users_sp, all_users_sp, one_users_sp, one_users_email_sp, send_recovery_email, send_verification_code, verify_code
...
def send_code(json: dict):
    return send_verification_code(json)
