...
@router.post("/api/client-face-recognition/verify", summary="Biometric verify ClientFaceRecognition", tags=["connector"])
async def verify_clientFaceRecognition(json: dict):
    return await verify_clientFaceRecognition_connector(json)


@router.post("/api/client-face-recognition/contract", summary="Submit contract ClientFaceRecognition", tags=["connector"])
