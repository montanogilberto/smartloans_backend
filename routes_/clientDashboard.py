...
from modules.clientDashboards import clientDashboards_sp, all_clientDashboards_sp, one_clientDashboards_sp
...
with open("./docs_description/clientDashboards_one.txt", "r") as file:
    clientDashboards_one_docstring = file.read()
@router.post("/one_clientDashboards", summary="one clientDashboard", description=clientDashboards_one_docstring)
def one_clientDashboards(json: dict):
    return one_clientDashboards_sp(json)