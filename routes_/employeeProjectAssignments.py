...
from modules.employeeProjectAssignments import employeeProjectAssignments_sp, all_employeeProjectAssignments_sp, one_employeeProjectAssignments_sp
...
def employee_project_assignments(json: dict):
    return employeeProjectAssignments_sp(json)
...
def all_employee_project_assignments():
    return all_employeeProjectAssignments_sp()
...
def one_employee_project_assignment(json: dict):
    return one_employeeProjectAssignments_sp(json)
